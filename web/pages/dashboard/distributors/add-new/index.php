        ...
        <div class="dashboard-header">
            <div class="flex items-center gap-2 justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <h1 class="text-3xl font-semibold">Add New Distributor</h1>
                </div>
            </div>
            <a href="/dashboard/distributors" class="flex justify-end button-primary">Back to list</a>
        </div>

        <div class="dashboard-content">
            <form action="/dashboard/distributors/add-new/handler" method="POST" class="bg-white p-12 rounded shadow-md flex flex-col gap-2">
                ...
                <div class="flex justify-end m">
                    <button type="submit" class="button-success mt-3">Add Distributor</button>
                </div>
                </from>
        </div>
    </div>
