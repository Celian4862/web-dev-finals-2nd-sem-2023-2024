    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            <div class="flex items-center gap-2">
                <span class="material-symbols-rounded text-4xl">warehouse</span>
                <h1 class="text-3xl font-semibold">Distributors</h1>
                <span class="text-3xl text-gray-400 font-semibold">(<?= count($distributors) ?>)</span>
            </div>
            <a href="/dashboard/distributors/add-new" class="button-primary group-button">
        ...
        <div class="dashboard-content">
            ...
            DashboardTable::render(
                $distributors,
                ["Distributor ID", "Name", "Address", "Contact Email", "Contact Number"],
                function ($distributor) use ($path) {
                    $id = $distributor["id"];
                    return [
...
<?php if (isset($query["info"])) : ?>
    ...
    <?php if ($person) : ?>
        <div class="dashboard-info">
            <form class="dashboard-info-container" action="/dashboard/distributors/handler?<?= http_build_query($query); ?>" method="POST">
                ...
                <div class="dashboard-info-footer">
                    <button type="submit" name="updateDistributor" value="<?= $person["id"]; ?>" class="button-success group-button">
                        <span>Save</span>
                        <span class="material-symbols-rounded">save</span>
                    </button>
                    <button type="submit" name="deleteDistributor" value="<?= $person["id"] ?>" class="button-danger group-button">
                        <span>Delete</span>
