...
<div class="flex">
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-content">
            <form action="/dashboard/persons/add-new/handler" method="POST" class="bg-white p-12 rounded shadow-md flex flex-col gap-2">
                ...
                <div class="group-input-box mt-4">
                    <label for="isClient" class="flex items-center gap-2 flex-1">
                    ...
                    <label for="isDistributor" class="flex items-center gap-2 flex-1">
                        <div class="input-checkbox">
                            <input type="checkbox" id="isDistributor" name="isDistributor">
                            <span class="material-symbols-rounded">check</span>
                        </div>
                ...
                <div class="flex justify-end m">
                    <button type="submit" class="button-success mt-3">Add Person</button>
                </div>
                </from>
        </div>
    </div>
