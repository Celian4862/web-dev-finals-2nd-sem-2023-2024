...
<div class="h-dvh bg-building bg-blend-darken backdrop-brightness-75">
    <div class="w-3/4 h-full mx-auto py-12 bg-primary text-white shadow-2xl">
        <div class="
            flex justify-center items-center w-fit mx-auto mb-4 p-6
            aspect-square rounded-full bg-white shadow-xl
        ">
        ...
        <form action="/login/handler" method="POST" class="w-full max-w-[400px] mx-auto">
            ...
            <div class="flex flex-col mb-8">
                ...
                <input type="password" id="password" name="password" required data-error="<?= var_export(
                    $invalidPassword
                ) ?>" class="
                    p-2 rounded-md outline-none text-black ring-gray-300
                    hover:ring focus:ring transition-colors shadow-md
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input type="checkbox" id="remember" name="remember" class="
                        peer relative appearance-none w-5 h-5 border rounded outline-none ring-gray-300
                        hover:ring focus:ring after:content-[''] after:absolute after:w-full after:h-full
                        after:left-0 after:right-0 after:bg-no-repeat after:bg-center after:bg-[length:40px]
                        checked:after:bg-[url('/assets/check.svg')]
                    ">
                    <label for="remember" class="ml-2">Remember me</label>
                </div>
                <button type="submit" class="
                    px-4 py-2 rounded-md outline-none bg-green-500 ring-green-500 font-bold hover:bg-green-600
                    hover:ring focus:bg-green-600 focus:ring transition-colors shadow-md
                ">Login</button>
            </div>
        </form>
    </div>
